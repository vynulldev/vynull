...
// GeneratePSSI (the PSSI song-structure encoder) moved to link/prolink
// (prolink.GeneratePSSI) in the encoder relocation. ParsePSSI (the decoder,
// used by the import path) and the shared PSSIMaskBase stay here.
