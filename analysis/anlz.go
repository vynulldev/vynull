...
// GeneratePVB2 and its makeEmptyVB2Section helper moved to link/prolink
// (prolink.GeneratePVB2) as part of the encoder relocation. The ANLZ container
// helpers (makeSection, tags, WrapANLZ, ReadANLZSection, WriteANLZFiles) stay
// here because the serving/import paths still consume them directly.
